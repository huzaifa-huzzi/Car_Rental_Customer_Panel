...
class CustomCalendarDetail extends StatefulWidget {
  ...
  @override
  State<CustomCalendarDetail> createState() => _CustomCalendarDetailState();
}

class _CustomCalendarDetailState extends State<CustomCalendarDetail> {
